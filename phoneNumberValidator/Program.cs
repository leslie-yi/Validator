...
//Console.WriteLine("-----------------------------------------------");
//Console.WriteLine($"USA: {validateNumber.IsValidNumber("+12123789494")}"); //Returns Valid
//Console.WriteLine($"USA: {validateNumber.IsValidNumber("+1 212-378-9494")}"); //Returns Valid
